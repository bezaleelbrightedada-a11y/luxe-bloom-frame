...
export function TopNav({ user, onOpenSidebar }) {
  return (
    <header className="sticky top-0 z-30 border-b border-border/70 bg-background/75 backdrop-blur-xl">
      <div className="flex h-16 items-center gap-3 px-4 sm:px-6">
        ...
        <div className="ml-auto flex items-center gap-2">
          <button
            type="button"
            className="press hidden items-center gap-2 rounded-xl bg-primary px-3.5 py-2 text-sm font-semibold text-primary-foreground sm:inline-flex"
          >
